...
data = 'other-e-proteobacteria/HpPflA-contact-prediction-scores.tsv'
...
plt.ylim(801, 0)
plt.xlim(0, 801)
ax.set_aspect(801/801)
plt.tight_layout()
plt.savefig('../gremlin-plots/e-proteobacteria/HpPflA-gremlin-plot', dpi=300)
plt.show()
