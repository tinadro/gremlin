...
data = 'other-e-proteobacteria/AbPflA-contact-prediction-scores.tsv'
...
plt.ylim(666, 0)
plt.xlim(0, 666)
ax.set_aspect(666/666)
plt.tight_layout()
plt.savefig('../gremlin-plots/e-proteobacteria/AbPflA-gremlin-plot', dpi=300)
plt.show()
