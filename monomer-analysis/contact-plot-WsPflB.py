...
data = 'other-e-proteobacteria/WsPflB-contact-prediction-scores.tsv'
...
plt.ylim(792, 0)
plt.xlim(0, 792)
ax.set_aspect(792/792)
plt.tight_layout()
plt.savefig('../gremlin-plots/e-proteobacteria/WsPflB-gremlin-plot', dpi=300)
plt.show()
